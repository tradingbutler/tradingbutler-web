...
export const BROKERS: BrokerInfo[] = [
    {
        ...
        regulator: 'FCA',
        spreadFrac: 0.00005,
        affiliateUrl: 'https://example.com/open-account/alphafx',
    },
    {
        id: 'broker2',
        name: 'Vertex Markets',
        ...
        regulator: 'ASIC',
        spreadFrac: 0.00006,
        affiliateUrl: 'https://example.com/open-account/vertex',
    },
    {
        id: 'broker3',
        name: 'Titan Trade',
        ...
        regulator: 'CySEC',
        spreadFrac: 0.00008,
        affiliateUrl: 'https://example.com/open-account/titan',
    },
    {
        id: 'broker4',
        name: 'Meridian FX',
        ...
        regulator: 'FCA',
        spreadFrac: 0.0001,
        affiliateUrl: 'https://example.com/open-account/meridian',
    },
    {
        id: 'broker5',
        name: 'NovaTrade',
        ...
        regulator: 'FSCA',
        spreadFrac: 0.00012,
        affiliateUrl: 'https://example.com/open-account/novatrade',
    },
];
